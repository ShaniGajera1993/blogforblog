...
<body>
    ...
    <div class="container text-center blog-css">
        <h2><strong>Term of Use</strong></h2><br>
    </div>
        ...
        <div class="row">
            <div class="col-sm-8 p-4">
                <div class="blog-grid-top">
                    ...
                    <p>
                        For the purposes of these Terms of Use:<br><br>

                        1.<strong>Affiliate</strong> means an entity that controls, is controlled by or is under common
                        ...
                        2.<strong>Country</strong> refers to: Gujarat, India<br><br>

                        3.<strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
                        Agreement) refers to BlogForBlog.<br><br>

                        4.<strong>Device</strong> means any device that can access the Service such as a computer, a
                        cellphone or a digital tablet.<br><br>

                        5.<strong>Service</strong> refers to the Website.<br><br>

                        6.<strong>Terms of Use</strong> (also referred as "Terms") mean these Terms of Use that form the
                        entire agreement between You and the Company regarding the use of the Service. This Terms of Use
                        agreement has been created with the help of the Terms of Use Generator.<br><br>

                        7.<strong>Third-party</strong> Social Media Service means any services or content (including
                        data, information, products or services) provided by a third-party that may be displayed,
                        included or made available by the Service.<br><br>

                        8.<strong>Website</strong> refers to BlogForBlog, accessible from http://blogforblog.ml/<br><br>

                        9.<strong>You</strong> means the individual accessing or using the Service, or the company, or
                    ...
                    <p>
                        These are the Terms of Use governing the use of this Service and the agreement that operates
                        ...
                        with any part of these Terms of Use then You may not access the Service.
                    ...
                    <p>
                        ...
                        We strongly advise You to read the terms of use and privacy policies of any third-party web
                    ...
                    <p>
                        ...
                        reason whatsoever, including without limitation if You breach these Terms of Use.
                    ...
                    <p>
                        If you have questions or concerns about this Terms of Use, please email us at
                        sgajera681@rku.ac.in with “TERMS OF USE” in the subject line.
                    </p>
                </div>
            </div>
            <div class="col-sm-4">
