...
<body>
    ...
    <div class="container blog-css">
        <div class="row">
            <div style="padding-right:10px; text-align: justify; text-justify: inter-word; color:black;" class="col-md-8 p-4">                
                <div class="blog-grid-top">        
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                                &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to BlogsForBlog.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Terms and Conditions</strong> (also referred as &quot;Terms&quot;) mean these
                                ...
                                with the help of the <a style="color:#A30000;" href="https://www.termsfeed.com/terms-conditions-generator/"
                        ...
                        <li>
                            <p><strong>Website</strong> refers to BlogsForBlog, accessible from <a
                            style="color:#A30000;" href="https://blogsforblog.com" rel="external nofollow noopener"
                                    target="_blank">https://blogsforblog.com</a></p>
                        </li>
                        <li>
                    ...
                    <h5><strong>Severability and Waiver</strong></h5>
                    <h5>Severability</h5>
                    ...
                    <ul>
                        <li>By email: <a style="color:#A30000;" href="mailto:contact@blogsforblog.com"><u>contact@blogsforblog.com</u></a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-4">
